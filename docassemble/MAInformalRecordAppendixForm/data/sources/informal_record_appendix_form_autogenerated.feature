...
Scenario: Generated scenario
  Given I start the interview at "informal_record_appendix_form.yml"
  And the user gets to "download informal_record_appendix_form" with this data:
    | var | value |
    ...
    | appellee_supplemental_record_appendix | Sample answer |
    | appellant_record_appendix | Sample answer |
    | appendix_volume_total | Sample answer |
    | users[0].signature_date | 01/02/2026 |
    | second_party | Sample answer |
    | first_party | Sample answer |
    ...
    | informal_record_appendix_form_intro | Sample answer |
    | informal_record_appendix_form_download | Sample answer |
    | informal_record_appendix_form_intro | True |
    | informal_record_appendix_form_preview_question | True |
    | users.revisit | True |
